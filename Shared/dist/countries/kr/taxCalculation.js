...
export function calculateIncomeTax(postNpsIncome) {
    if (postNpsIncome <= 0)
        return 0;
    return incomeTaxFromGross(recoverGross(postNpsIncome));
}
// Local income tax = 10% of national income tax.
export function calculateLocalIncomeTax(postNpsIncome) {
    if (postNpsIncome <= 0)
        return 0;
...
export function calculateSocialInsurance(postNpsIncome) {
    if (postNpsIncome <= 0)
        return 0;
...
export function calculateNetIncome(postNpsIncome) {
    if (postNpsIncome <= 0)
        return 0;
...
export function getTaxBreakdown(postNpsIncome, _superContributions = 0) {
    if (postNpsIncome <= 0) {
