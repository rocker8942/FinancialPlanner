...
function getAdjustedAssetTestThresholds(cpiAdjustmentFactor = 1.0) {
...
function calculateDeemedIncome(financialAssets, relationshipStatus) {
...
function calculateAssetTest(params) {
...
function calculateIncomeTest(params) {
    ...
    const freeArea = relationshipStatus === 'couple'
        ? thresholds.freeAreaCombined
        : thresholds.freeArea;
    const cutOff = relationshipStatus === 'couple'
        ? thresholds.cutOffCombined
        : thresholds.cutOff;
...
export function calculateAgePension(params) {
...
export function getAgePensionAmounts(input) {
    const { relationshipStatus, isHomeowner, propertyAssets, savings, superannuation, mortgageBalance, userSalary, partnerSalary, userAge, partnerAge, cpiAdjustmentFactor = 1.0, partnerSuperBalance = 0 } = input;
