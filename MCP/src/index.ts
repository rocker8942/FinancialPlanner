...
const financialProfileSchema = z.object({
  ...
  mortgageRate: z.number().default(0.06).describe('Annual mortgage interest rate as decimal (e.g. 0.06 for 6%)'),
  superannuationRate: z.number().default(0.07).describe('Annual superannuation return rate as decimal (e.g. 0.07 for 7%)'),
  savingsGrowthRate: z.number().default(0.025).describe('Annual savings/investment growth rate as decimal'),
  propertyGrowthRate: z.number().default(0.03).describe('Annual property growth rate as decimal (e.g. 0.03 for 3%)'),
  propertyRentalYield: z.number().default(0.033).describe('Net rental yield as decimal (e.g. 0.033 for 3.3%)'),
  cpiGrowthRate: z.number().default(0.03).describe('Annual CPI/inflation rate as decimal (e.g. 0.03 for 3%)'),
  ...
  deathAge: z.number().default(90).describe('Age to project plan until (plan end age)'),
